...
<!-- Bootstrap core CSS -->
   ...
   <script src="{{  secure_asset('/js/jquery-3.1.1.min.js') }}"></script>
    ...
    <script src="{{  secure_asset('/js/plugins/toastr/toastr.min.js') }}"></script>
    <script src="{{  secure_asset('/js/patient-add.js') }}"></script>
    <script src="{{  secure_asset('/js/doctor-add.js') }}"></script>
    <script src="{{  secure_asset('/js/cita-add.js') }}"></script>
    -->
